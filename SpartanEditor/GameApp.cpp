...
//}
//
//GameTool::GameTool(const Spartan::GameSettings &settings) : Spartan::BaseGame(settings), m_Buffer("")
//{
//}
//
//GameTool::~GameTool()
...
//}
//
//void GameTool::Initialize(const Spartan::GameContext &gameContext)
//{
//	// Init GLEW
//	glewInit();
//
...
//}
//
//void GameTool::GamePaint(const Spartan::GameContext &gameContext)
//{
//	GLsizei w = (GLsizei)m_GameSettings.Window.Width;
//	GLsizei h = (GLsizei)m_GameSettings.Window.Height;
