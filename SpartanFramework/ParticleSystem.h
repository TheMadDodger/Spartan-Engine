...
//};
//
//class ParticleTransform : SEObject
//{
//public:
//	ParticleTransform() : m_Position(Vector3::Zero()), m_Rotation(Vector3::Zero()), m_Scale(1, 1, 1), m_TransformMatrix(Matrix4X4::CreateIdentityMatrix()) {}
...
//};
//
//class ParticleEmitter : SEObject
//{
//public:
